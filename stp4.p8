...
function game_init()
 ...
 stadium.fans={80,81,82,84,85,86}
 stadium.audience={}
...
--  sfx(5) sfx(6) sfx(7)
  --do something silly
--  set_player_sprite(num,players[num].sprites[6])
  if(abs(oddball.x-players[num].x)>15) then
...
--  if(moving) then players[p].sprite=players[p].sprites[1+flr(rnd(2))] end
  ...
  if(btnp(4,p-1)) then player_service(p) end
 ...
 if(abs(oddball.x-players[approaching_player].x)<2) then
  ...
  if(oddball.y>=shieldhity1 and oddball.y<=shieldhity2) then
   if(not players[approaching_player].dancing) then
    ...
    elseif(offset<8) then oddball.dy*=0.5 oddball.dy+=-0.1+rnd(0.2)
...
-- from game_update
 if(players[num].dancing) then
  ...
  elseif(cycles-players[num].started_dancing<16) then
   players[num].stagger_effect=nil
...
function draw_audience()
 for seat=1,#stadium.seats do
  ...
  --put an audience member in 
  -- each seat, facing the ball
...

...

